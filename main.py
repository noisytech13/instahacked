...
from src.instahacked import instahacked
import argparse
...
parser = argparse.ArgumentParser(description='instahacked is a OSINT tool on Instagram. It offers an interactive shell '
...
api = instahacked(args.id, args.file, args.json, args.command, args.output, args.cookies)
